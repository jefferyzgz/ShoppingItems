...
class ShoppingListViewModel(
    ...
    private fun createNewShoppingList() {
        viewModelScope.launch {
            ...
            Transformations.map(currentShoppingList) {
                    nights -> Log.i("createdNewList-vm-1", "111:"+nights.toString())
            }
    ...
    fun insertNewShoppingItemToList(listId: Long, itemName: String, amount: Long, unit: String, priority: Int) {
        viewModelScope.launch {
